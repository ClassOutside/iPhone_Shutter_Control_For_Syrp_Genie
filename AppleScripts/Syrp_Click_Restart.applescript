        ...
        tell targetApp
            ...
            if syrpWindows is not {} then
                ...
                repeat with anElement in uiElements
                    -- Check if the element is a button with the description "ReturnHomeIcon passive"
                    if (class of anElement is button) and (description of anElement is "ReturnHomeIcon passive") then
                        -- Click the button
                        click anElement
                ...
                if not buttonPressed then
                    -- display dialog "Button with description 'ReturnHomeIcon passive' not found." buttons {"OK"} default button "OK" with icon caution
                end if
            else
